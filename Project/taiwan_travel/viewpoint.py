...
def viewpoint():
    # 網頁下載點
    urls = "https://media.taiwan.net.tw/XMLReleaseALL_public/Scenic_Spot_C_f.csv"
    ...
    # 確認所需欄位是否存在
    required_columns = ["Name", "Tel", "Add", "Region", "Town", "Opentime", "Px", "Py", "Parkinginfo", "Ticketinfo"]
